...
mkArityType (ForAllTy tv body_ty) n = ForAllTy tv (mkArityType body_ty n)
mkArityType (FunTy arg res)       0 = FunTy arg (mkArityType res 0)
mkArityType (FunTy arg res)       n = FunTildeTy arg (mkArityType res (n-1))
mkArityType ty                    _ = ty
